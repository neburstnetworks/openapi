...
All requests are authenticated using **HMAC-SHA256** signatures. You need an API Key (`key_id` + `secret`) created from the [Neburst Dashboard](https://dash.neburst.com).
...
See [docs/authentication.md](docs/authentication.md) for the full signing algorithm and examples.
...
60 requests per minute per user. See [docs/rate-limiting.md](docs/rate-limiting.md).
...
- [Authentication](docs/authentication.md) - HMAC-SHA256 signing flow
